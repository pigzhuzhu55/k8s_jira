----------------------------------------------
Jira 8.1.0-#801000 README
----------------------------------------------

Thank you for downloading Jira 8.1.0. This distribution comes with a
...
Full documentation:
http://docs.atlassian.com/jira/jadm-docs-081/Installing+Jira+applications
...
2. Set the JAVA_HOME variable to where you installed Java.
   ...
   http://docs.atlassian.com/jira/jadm-docs-081/Installing+Java

3. Set your Jira home directory.

   See the following instructions for details:
   http://docs.atlassian.com/jira/jadm-docs-081/Setting+your+Jira+application+home+directory
...
Full documentation:
http://docs.atlassian.com/jira/jadm-docs-081/Upgrading+Jira+applications
...
-  Complete the pre-upgrade steps that include running a Jira health check,
   ...
   See the following instructions for details:
   http://docs.atlassian.com/jira/jadm-docs-081/Preparing+for+the+upgrade
...
3. If you're using an Oracle or MySQL database, download the database driver
   ...
   Supported drivers:
   http://docs.atlassian.com/jira/jadm-docs-081/Supported+platforms
...
Try the docs at:
http://docs.atlassian.com/jira/jadm-docs-081/
