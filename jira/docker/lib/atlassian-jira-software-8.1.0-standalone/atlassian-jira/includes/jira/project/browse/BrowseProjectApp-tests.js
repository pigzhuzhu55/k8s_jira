AJS.test.require('jira.webresources:browseprojects', function () {
    ...
    require(['underscore', 'backbone', 'jquery', 'jira/util/users/logged-in-user', 'jira/util/data/meta', 'jira/project/browse/app', 'jira/util/navigation'], function (_, Backbone, $, loggedInUser, meta, BrowseProjectsApp, navigation) {
        ...
        module('BrowseProjectApp', {
            setup: function setup() {
                ...
                this.BrowseProjectsApp = BrowseProjectsApp;
            ...
            teardown: function teardown() {
                ...
                // document.location.href = location.substr(0, location.indexOf("?"));
            }
        });
