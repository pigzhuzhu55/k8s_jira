define('jira/project/browse/projectview', ['jquery', 'marionette', 'jira/util/data/meta', 'jira/moment', 'wrm/context-path', 'aui/flag', 'jira/ajs/ajax/ajax-util'], function ($, Marionette, meta, moment, contextPath, flag, ajaxUtil) {
    'use strict';
